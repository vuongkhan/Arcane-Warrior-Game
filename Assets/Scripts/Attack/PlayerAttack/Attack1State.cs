...
public class Attack1State : BaseState<PlayerStateMachine.PlayerState>
{
    ...
    public Attack1State(StateMachine<PlayerStateMachine.PlayerState> stateMachine, Animator animator, Rigidbody2D rb, Transform attackPosition, AudioManager audioManager)
        : base(stateMachine, PlayerStateMachine.PlayerState.Attack1)
    {
        _animator = animator;
        _rb = rb;
    ...
    {
        _audioManager.PlaySoundEffect("splash1");
        Debug.Log("Entering Attack1 State");
    ...
    {
        Debug.Log("Exiting Attack1 State");
    }
    ...
    public override void UpdateState()
    {
        ...
        {
            StateMachine.QueueNextState(PlayerStateMachine.PlayerState.Attack2);
        }
    }
